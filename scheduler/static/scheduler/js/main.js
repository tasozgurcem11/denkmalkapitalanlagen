(function main() {
    ...
    ScheduleTemplate.prototype.initEvents = function () {
        ...
        for (var i = 0; i < this.singleEvents.length; i++) {
            ...
            this.singleEvents[i].addEventListener('click', function (event) {
                ...
                var modalToOpen = this.getElementsByTagName('a')[0]
                if (!self.animating && (modalToOpen.getAttribute("data-content") !== "reserved" && modalToOpen.getAttribute("data-content") !== "outdated")) self.openModal(modalToOpen);
            });
        }
        //close modal window
    ...
    ScheduleTemplate.prototype.loadEventContent = function (content) {
        ...
        if (content !== "reserved" && content !== "outdated") {
    ...
    ScheduleTemplate.prototype.setScheduleRowNumbers = function (){
        var columnNumber = document.querySelectorAll("#events").length;
        var eventNumber = document.querySelectorAll("#events li").length;
        var rowNumber = eventNumber/columnNumber*2 - 1
        var root = document.documentElement;
        root.style.setProperty("--schedule-rows-number", rowNumber);
    }
